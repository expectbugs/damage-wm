...
Adam's ruling** (skip after a rebuild inside the lease's remaining time on the dropped arm; no flag; to
build, priced by the journal's `atlas` notes); MTU and packing if F1.8 ships.
