...
| **The phone's per-flush CPU is ~63 % painting, ~27 % diff and plan, ~8 % truth render, ~2 % compression** | **M** | the §34.2 split over 341 flushes; what inside the painting is **U** until the 0.32 cut is walked |
