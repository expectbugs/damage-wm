...
| A classic audio device (`98:3A:1F:EE:84:77`, HFP/A2DP) shared the phone's radio with both lenses in every 2026-09-14 capture; the phone logged 227 "A2DP audio choppy" quality reports in 24 minutes while the glasses' links ran at 15 ms | **M** | `captures/apk-20260914-1731-1756.log` BQR events. Whether it is the §31 slow side is open (the journal's `SLOW regime` flips today coincide with it) |
