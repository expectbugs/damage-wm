...
| **During both drop-free overnight windows of 2026-09-13/14 the glasses were in the charging case in the bedroom** — charging, folded, lid closed, stationary, unworn — with the session up and the lease renewed all night; the six overnight rebuilds of 2026-09-07/08 (`HANDOFF.md` §42.0) came with the glasses out of the case (§42.2's RF line says on a desk; Adam to confirm) | **M** (Adam, 2026-09-14) | the first discriminator among §42.2's ten: the periodic drop stops in the case. Which of charging, the fold and the case detect gates it is the evening experiment `FORK.md` M0.7 (`HANDOFF.md` §50.6); a free-running per-arm clock (§42.2 item 1 as written), a low-traffic deep sleep (item 6) and case attenuation (item 7's case half) fit it poorly; a state-gated task (items 1/2 gated on active), a battery-saver cycle off while charging (item 8) and the head/pocket geometry (item 7's worn half) fit |
